      ...
      >
        <h1
          ...
          style={{
            ...
            lineHeight: 1.2,
            marginBottom: '4rem',
            background: 'linear-gradient(90deg, #4A90E2, #9B59B6, #F39C12, #4A90E2)',
        ...
        <a
          ...
          onMouseEnter={(e) => {
            ...
            e.currentTarget.style.boxShadow = '0 20px 60px rgba(255, 0, 255, 0.5)';
            const before = e.currentTarget.querySelector('.cta-before') as HTMLDivElement;
