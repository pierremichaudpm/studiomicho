...
const translations: Record<Locale, Record<string, string>> = {
  fr: {
    ...
    "testimonials.noah.quote": "Studio Micho a rapidement compris nos enjeux opérationnels et a su développer un outil adapté à notre réalité. Leur équipe a fait preuve d'écoute, de flexibilité et d'un grand professionnalisme tout au long du mandat. La collaboration a été fluide, efficace et agréable du début à la fin.",
    "testimonials.noah.name": "Noah L'abbée",
    "testimonials.noah.role": "Quartier des spectacles international",
    ...
    "method.5.desc": "Produit livré avec une documentation technique complète, un guide de continuité et un plan de suivi solide.",
    ...
    "pitch.cta": "Contactez-nous",
    "pitch.subcta": "Quelque chose vous ralentit, vous empêche d'avancer? On en parle?",
  ...
  en: {
    ...
    "testimonials.catherine.name": "Catherine Dupont",
    "testimonials.catherine.role": "Groupe Tonic",
    "testimonials.noah.quote": "Studio Micho quickly understood our operational challenges and developed a tool tailored to our reality. Their team demonstrated attentiveness, flexibility and great professionalism throughout the mandate. The collaboration was smooth, efficient and pleasant from start to finish.",
    "testimonials.noah.name": "Noah L'abbée",
    "testimonials.noah.role": "Quartier des spectacles international",
    ...
    "method.5.desc": "Product delivered with full technical documentation, a continuity guide and a solid follow-up plan.",
    ...
    "pitch.cta": "Contact us",
    "pitch.subcta": "Something slowing you down, holding you back? Let's talk.",
    "pitch.footer": "Studio Micho × JAXA Production · Montréal",
    "pitch.footerBy": "by",
