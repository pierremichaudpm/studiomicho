...
const translations: Record<Locale, Record<string, string>> = {
  fr: {
    ...
    "services.1.desc": "Sites vitrines ou plus complexes, applications, prototypes — en ligne en 3 semaines. Optimisé, rapide, construit avec l'IA.",
  ...
  en: {
    ...
    "services.1.desc": "Showcase or complex sites, applications, prototypes — online in 3 weeks. Optimized, fast, AI-built.",
