...
const translations: Record<Locale, Record<string, string>> = {
  fr: {
    ...
    "modal.aurea.desc": "Site vitrine conseil RH. Livré en 2 semaines, build solo de A à Z.",
    "modal.aurea.tag1": "Solo de A à Z",
  ...
  en: {
    ...
    "modal.aurea.desc": "HR consulting showcase site. Delivered in 2 weeks, solo build from A to Z.",
    "modal.aurea.tag1": "Solo A to Z",
